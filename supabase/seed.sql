...
insert into public.case_studies (
  ...
  ('entrepot-pilotage', 'Pilotage d’un entrepôt multi-zone', 'Logistique',
   ...
   'https://pspqvjiqemsphdvoslqe.supabase.co/storage/v1/object/public/content-images/site/images/mechanical-room.webp', 'Salle des machines d’un entrepôt logistique',
  ...
  ('site-froid', 'Optimisation d’une installation frigorifique', 'Froid',
   ...
   'Exemple de projet — données de démonstration',
   'https://pspqvjiqemsphdvoslqe.supabase.co/storage/v1/object/public/content-images/site/images/refrigeration-plant.webp', 'Centrale de production frigorifique',
  ...
  ('batiment-tertiaire', 'Rénovation énergétique d’un bâtiment tertiaire', 'Tertiaire',
   ...
   'Exemple de projet — données de démonstration',
   'https://pspqvjiqemsphdvoslqe.supabase.co/storage/v1/object/public/content-images/site/images/external/photo-1497366811353-6870744d04b2.webp', 'Local technique CVC d’un immeuble de bureaux',
...
insert into public.blog_posts (
  ...
  ('comprendre-les-cee',
   ...
   'https://pspqvjiqemsphdvoslqe.supabase.co/storage/v1/object/public/content-images/site/images/refrigeration-plant.webp', 'Installation technique industrielle',
  ...
  ('audit-energetique-par-ou-commencer',
   ...
   'https://pspqvjiqemsphdvoslqe.supabase.co/storage/v1/object/public/content-images/site/images/mechanical-room.webp', 'Salle des machines d’un site industriel',
  ...
  ('haute-pression-flottante-froid',
   ...
   'https://pspqvjiqemsphdvoslqe.supabase.co/storage/v1/object/public/content-images/site/images/air-compressor-room.webp', 'Compresseurs d’une centrale frigorifique',
