...
export const solutionIcons = {
  ...
  'haute-pression-flottante':'Gauge', 'regulation-froid':'Snowflake', 'moteurs-variateurs':'Cog',
  eclairage:'Lightbulb', 'air-comprime':'Wind', 'pilotage-energetique':'ChartNoAxesCombined',
};
export const sectorIcons = {industrie:'Factory',tertiaire:'Building2',logistique:'Warehouse',commerce:'Store',agroalimentaire:'Wheat',sante:'Hospital'};
