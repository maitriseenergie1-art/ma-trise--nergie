...
export function ProcessBar({ contact = false }) {
  const steps = [
  ...
  const stepList = steps.map(([Icon, label, text], index) => <div className="process-step" key={label}>
  ...
  if (!contact) {
    return <section className="process" id="notre-methode" aria-labelledby="method-title">
      ...
      <Container>{stepList}</Container>
    </section>;
  }

  return <section className="process process-with-contact" id="notre-methode" aria-labelledby="method-title">
    <div className="process-layout">
      <div className="process-main">
        ...
        <div className="process-steps">{stepList}</div>
      </div>
      <aside className="process-contact">
...
export function MobileEligibilityCta() {
  return <Section className="mobile-eligibility-cta" tone="muted">
    <Container><QuickLeadForm variant="eligibility" dense/></Container>
  </Section>;
}
