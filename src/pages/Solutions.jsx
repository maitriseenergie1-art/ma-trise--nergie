...
export default function Solutions() {
  ...
  return <><Seo title="Solutions" description="Solutions de performance énergétique pour les installations et bâtiments."/>
    <PageHero eyebrow="Solutions" title="Des solutions pour améliorer la performance énergétique de vos installations." text="Chaque solution répond à un usage, un équipement et un contexte. Nous relions l’analyse, le financement, les travaux et le suivi." image={heroImages.industry} imageAlt=""><Button to="/eligibilite" sourceCta="solutions_hero_contact">Vérifier mon éligibilité</Button></PageHero>
